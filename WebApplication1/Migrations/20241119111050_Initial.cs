    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateOnly(2000, 10, 10), 0, new DateTime(2024, 11, 19, 12, 10, 49, 510, DateTimeKind.Local).AddTicks(652), "adam@wsei.edu.pl", "Adam", "Kowal", 101, "123456789" },
                    { 2, new DateOnly(2000, 10, 10), 0, new DateTime(2024, 11, 19, 12, 10, 49, 510, DateTimeKind.Local).AddTicks(716), "ewa@wsei.edu.pl", "Ewa", "Kowal", 102, "123456789" }
                });
